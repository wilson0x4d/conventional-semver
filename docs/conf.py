...
project = 'conventional-semver'
author = 'Shaun Wilson'
copyright = f'2026 {author}'
from conventional_semver import __version__
...
html_theme = 'furo'
html_title = "conventional-semver<br><span style='font-size: x-small'>..a conventional commits processor.</span>"
